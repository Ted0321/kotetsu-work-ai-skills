...
|---|---|---|---|---|---|---|
| 未定 | claude-cache-cleanup | Claude Code 週次おそうじ | v0.2 | コピペ型＋エージェント型 | [skills/claude-cache-cleanup](./skills/claude-cache-cleanup/) | プロンプト1枚で、溜まった古いログとキャッシュを毎週勝手に片付ける |
